...
export async function POST(request) {
  try {
    ...
    const prompt = `You are an AI assistant for RankHawk. Generate a concise daily briefing in 2 sentences based on: ${JSON.stringify(body)}. Be specific and actionable.`
    ...
    return NextResponse.json({ briefing: 'Your RankHawk dashboard is ready.' })
  }
}
